...
path('day4continues/',views.day4_1, name='day4.1'),
path('day5/',views.day5, name='day5'),
path('day5continues/',views.day5_1, name='day5.1'),
path('day6/',views.day6, name='day6'),
path('day6continues/',views.day6_1, name='day6.1'),
path('day7/',views.day7, name='day7'),
path('day7continues/',views.day7_1, name='day7.1'),
path('day8/',views.day8, name='day8'),
path('day8continues/',views.day8_1, name='day8.1'),
path('day9/',views.day9, name='day9'),
path('day9continues/',views.day9_1, name='day9.1'),
path('day10/',views.day10, name='day10'),
path('day10continues/',views.day10_1, name='day10.1'),
